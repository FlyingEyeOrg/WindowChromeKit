...
| `VsCode` | `#141414` | `#1D1E1F` | `#E5EAF3` / `#A3A6AD` | `#303030` / `#424243` | `#F56C6C` / `#F78989` |
| `Windows` | `#FFFFFF` | `#F2F6FC` | `#303133` / `#909399` | `#ECF5FF` / `#D9ECFF` | `#C42B1C` / `#A92316` |

浅色底那两款的关闭按钮**直接用 Windows 原生那一对**（悬停 `#C42B1C`、按下 `#A92316`，实测值）；
深色底的 VS Code 款保留 Element Plus 的亮红（原生红在近黑底上偏暗）。
...
- [ ] `VsCode` 款的深色主题下，关闭按钮按下比悬停**更亮**（`dark-2` 向白混）
- [ ] 浅色底那两款的关闭按钮与 Windows 样式用**同一对**红（`#C42B1C` / `#A92316`）
