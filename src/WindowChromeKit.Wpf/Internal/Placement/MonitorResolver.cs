...
internal static class MonitorResolver
{
    internal static MonitorTarget Resolve(Window? owner, Window? currentWindow = null)
    {
        ...
        {
            throw new Win32Exception(Marshal.GetLastWin32Error(), "无法读取目标显示器信息。");
        }
        ...
        return new MonitorTarget(monitorHandle, monitorInfo.WorkArea, dpiX, dpiY);
    }
