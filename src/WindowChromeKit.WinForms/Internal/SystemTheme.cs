...
internal static class SystemTheme
{
    ...
    internal static ChromeTitleBarLook Look(ChromeTitleBarStyle style) => style switch
    {
        ChromeTitleBarStyle.VsCode => new ChromeTitleBarLook(
            VsCode,
            closeButtonHover: Color.FromArgb(0xE8, 0x11, 0x23),
            closeButtonPressed: Color.FromArgb(0xC5, 0x0F, 0x1F)),
        ChromeTitleBarStyle.Windows => new ChromeTitleBarLook(
            Current,
            closeButtonHover: Color.FromArgb(0xC4, 0x2B, 0x1C),
            closeButtonPressed: Color.FromArgb(0xA9, 0x23, 0x16)),
        _ => new ChromeTitleBarLook(
            Current,
            closeButtonHover: Color.FromArgb(0xE8, 0x11, 0x23),
            closeButtonPressed: Color.FromArgb(0xF1, 0x70, 0x7A)),
    };
